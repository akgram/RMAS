package com.example.checkcount.location
...
import com.example.checkcount.MainActivity
...
class LocationService : Service() {
    ...
    private val notifiedObjs = mutableSetOf<String>()
    ...
    private fun start(
        ...
        locationClient.getLocationUpdates(1000L)
            ...
            .onEach { location ->
                ...
                if(nearby){
                    checkProximityToObj(location.latitude, location.longitude)
                }
    ...
    private fun createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Obaveštavamo vas da se vaša lokacija prati u pozadini kako bi se proverilo da li ste u blizini nekog objekta"
            }
    ...
    private fun checkProximityToObj(latitude: Double, longitude: Double) {
        ...
        firestore.collection("objects").get()
            .addOnSuccessListener { result ->
                for (document in result) {
                    ...
                    geoPoint?.let {
                        ...
                        if (distance <= 100 && !notifiedObjs.contains(document.id)) {
                            sendObjNotification()
                            notifiedObjs.add(document.id)
            ...
            .addOnFailureListener { e ->
                Log.e("LocationService", "Error fetching objects", e)
            }
    }
    ...
    private fun sendObjNotification() {
        val notificationChannelId = "LOCATION_SERVICE_CHANNEL"
        ...
        val notification = NotificationCompat.Builder(this, notificationChannelId)
            ...
            .setContentText("Nalazite se u blizini novog objekta!")
            .setSmallIcon(R.drawable.logo)
            .setContentIntent(pendingIntent)
            .build()

        val notificationManager = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        notificationManager.notify(OBJ_NOTIFICATION_ID, notification)
    }
    ...
    companion object {
        ...
        private const val OBJ_NOTIFICATION_ID = 2
    }
}
